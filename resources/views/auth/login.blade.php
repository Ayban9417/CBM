...
<body class="skin-blue card-no-border">
    ...
    <section id="wrapper">
        <div style="background-color:#EDEDED;">
            <img src="../assets/images/log-in-page-logo.png" width="30%" style="background-color:transparent; margin-top:1%; margin-left:35%;"/>
        </div>
                    ...
                    <form class="form-horizontal form-material" id="loginform" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group text-center">
                            <div class="col-xs-12 p-b-20">
                                <button class="btn btn-block btn-info btn-rounded" type="submit" style="background-color:#F69438; border:none;">Log In</button>
                            </div>
                        </div>
