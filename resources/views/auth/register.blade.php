...
<head>
    ...
    <title>Register || Community Builders Alliance</title>
...
<body class="skin-blue card-no-border">
    ...
    <div style="background-color:#EDEDED;">
            <img src="../assets/images/log-in-page-logo.png" width="20%" style="background-color:transparent; margin-top:1%; margin-left:38%;"/>
        </div>
            ...
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email"
                                    value="{{ old('email') }}" type="email" required="" placeholder="Email">
                        ...
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}"
                                    name="username" value="{{ old('username') }}" type="text" required=""
                        ...
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone"
                                    value="{{ old('phone') }}" type="text" required="" placeholder="Phone Number">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input class="form-control" name="by" value="{{$ref}}" type="text"
                                    placeholder="Referrer (Optional)" readonly="true">
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="customCheck1">I agree to all <a
                                            href="https://drive.google.com/file/d/1bD_AARFbnGH-uExB3YTIzQuto2PUQuSU/view?usp=sharing" target="_blank">Terms</a></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group text-center p-b-20">
                            <div class="col-xs-12">
                                <button
                                    ...
                                    type="submit" style="background-color:#F69438; border:none;">Sign Up</button>
                            </div>
                        </div>
