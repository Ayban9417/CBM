...
<div class="row">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12">
                        <h3 class="text-success">Php {{ !$wallet ? 0 : number_format($wallet->amount) }}</h3>
    ...
    <div class="col-lg-4 col-md-4">
        <div class="card">
            <div class="card-body">
                <h6 class="card-subtitle">Minimum Withdrawal: Php500</h6>
                <div class="row">
                    <div class="col-12">
    ...
    <div class="col-lg-4 col-md-6">
        <div class="card">
            <div class="card-body">
                @if(!$account)
                <a href="javascript:void(0)" data-toggle="modal" data-target="#daModal"
                    class="btn btn-outline-success float-right mb-2">Add Account</a>
                @else
                <a href="javascript:void(0)" data-toggle="modal" data-target="#daModal1"
                    class="btn btn-outline-info float-right mb-2">Edit Account</a>
                @endif
                <div class="clearfix"></div>
                <div class="row">
                    <div class="col-12">
                        <h6 class="text-dark">Acount Name/Personal:</h6>
                        <h6 class="text-info">{{ $account ? $account->account_name : "N/A"}}</h6>
                        <h6 class="text-dark">Phone Number:</h6>
                        <h5 class="text-info">{{$account ? $account->account_no : "N/A"}}</h5>
                        <h6 class="text-dark">Withdrawal Option (Walk-in, Gcash):</h6>
                        <h6 class="text-info">{{$account ? $account->bank_name : "N/A"}}</h6>
...
<div id="daModal1" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
    style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Edit Withdrawal Details</h4>
            ...
            <form method="post" action="/user-accounts/{{$account ? $account->id : ''}}">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="recipient-name" class="control-label">Account/Personal Name:</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="account_no"
                            value="{{$account ? $account->account_no : ''}}">
                    </div>

                    <div class="form-group">
                        <label for="recipient-name" class="control-label">Withdrawal Option (Walk-in, Gcash):</label>
...
<div id="daModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
    style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
